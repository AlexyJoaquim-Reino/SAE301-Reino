...
<body>
    <form action="modifier_projet" method="post" enctype="multipart/form-data">
        <div class="mb-3 container d-flex flex-column justify-content-center align-items-center w-25 mb-5 mt-5">
            ...
            <input class="form-control" required type="text" name="etudiants" id="" value="<?php echo (($projet['etudiants'])); ?>">

            <label class="form-label" for="date_debut_projet">Date de début</label>
            <input class="form-control" required type="date" name="date_debut_projet" id="" value="<?php echo (($projet['date_debut_projet'])); ?>">

            <label class="form-label" for="date_fin_projet">Date de fin</label>
            <input class="form-control" required type="date" name="date_fin_projet" id="" value="<?php echo (($projet['date_fin_projet'])); ?>">

            <label class="form-label" for="niveau">Niveau</label>
            <input class="form-control" required type="text" name="niveau" id="" value="<?php echo (($projet['niveau'])); ?>">

            <label class="form-label" for="description">Description*</label>
            <input class="form-control" required type="text" name="description" id="" value="<?php echo (($projet['description'])); ?>">

            <label class="form-label" for="iframe_projet">Lien de la vidéo</label>
            <input class="form-control" type="text" name="iframe_projet" id="" value="<?php echo (($projet['iframe_projet'])); ?>">

            <label class="form-label" for="lien">Lien</label>
            <input class="form-control" type="text" name="lien" id="" value="<?php echo (($projet['lien'])); ?>">
